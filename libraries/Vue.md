...
**Note**: The original `<todo-item>` tag will be replaced with the new `<li>` tag. Classes/attributes in both tags will be merged. This is very different from what happens in Angular.
